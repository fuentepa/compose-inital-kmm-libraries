...
class MoviesRepositoryImpl(@InjectedParam private val apiService: TMDBApiService) : MoviesRepository {
    ...
    override suspend fun getMovieDetail(id: Int): Result<Movie> = tryCall {
